import { Activity, ClipboardList, CreditCard, Home, LayoutDashboard, LockKeyhole, LogOut, Package, ShieldAlert, ShieldCheck, Siren, Users, Wrench } from 'lucide-react';
...
const sections: { label: string; items: NavItem[] }[] = [
  ...
  { label: 'System', items: [{ label: 'Lock Exclusions', to: '/admin/remote-lock-exclusions', icon: LockKeyhole }, { label: 'Admin Users', to: '/admin/admin-users', icon: ShieldCheck }] },
];
